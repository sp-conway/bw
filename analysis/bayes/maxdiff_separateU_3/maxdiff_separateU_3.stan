...
parameters {
  ...
  real<lower=0> b_competitor_best_s_sigma;
  real<lower=0> b_competitor_worst_s_sigma;
  real<lower=0> b_decoy_best_s_sigma;
  real<lower=0> b_decoy_worst_s_sigma;
...
transformed parameters{
  ...
  for(i in 1:N){
    ...
    U_best[i,2] = (b_competitor_best_x_distance2_s[sub_ns[i]]+
    ...
    // Utility of competitor option          
    U_worst[i,2] = (b_competitor_worst_x_distance2_s[sub_ns[i]]+
    ...
    U_best[i,3] = (b_decoy_best_x_distance2_s[sub_ns[i]]+
              ...
              // Utility of decoy option
    U_worst[i,3] = (b_decoy_worst_x_distance2_s[sub_ns[i]]+
...
model {
  ...
  b_competitor_best_s_sigma ~ cauchy(0,2.5);
  b_competitor_worst_s_sigma ~ cauchy(0,2.5);
  b_decoy_best_s_sigma ~ cauchy(0,2.5);
  b_decoy_worst_s_sigma ~ cauchy(0,2.5);
  
  b_competitor_best_x_distance2_s ~ normal(0, b_competitor_best_s_sigma); //
  b_competitor_best_x_distance5_s ~ normal(0, b_competitor_best_s_sigma); //
  b_competitor_best_x_distance9_s ~ normal(0, b_competitor_best_s_sigma); //
  b_competitor_best_x_distance14_s ~ normal(0, b_competitor_best_s_sigma); //
  b_competitor_worst_x_distance2_s ~ normal(0, b_competitor_worst_s_sigma); //
  b_competitor_worst_x_distance5_s ~ normal(0, b_competitor_worst_s_sigma); //
  b_competitor_worst_x_distance9_s ~ normal(0, b_competitor_worst_s_sigma); //
  b_competitor_worst_x_distance14_s ~ normal(0, b_competitor_worst_s_sigma); //

  b_decoy_best_x_distance2_s ~ normal(0, b_decoy_best_s_sigma); //
  b_decoy_best_x_distance5_s ~ normal(0, b_decoy_best_s_sigma); //
  b_decoy_best_x_distance9_s ~ normal(0, b_decoy_best_s_sigma); //
  b_decoy_best_x_distance14_s ~ normal(0, b_decoy_best_s_sigma); //
  b_decoy_worst_x_distance2_s ~ normal(0, b_decoy_worst_s_sigma); //
  b_decoy_worst_x_distance5_s ~ normal(0, b_decoy_worst_s_sigma); //
  b_decoy_worst_x_distance9_s ~ normal(0, b_decoy_worst_s_sigma); //
  b_decoy_worst_x_distance14_s ~ normal(0, b_decoy_worst_s_sigma); //

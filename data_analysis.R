...
d_att_choice <- d_att %>%
  ...
  mutate(best=case_when(
    choice_best==min~"d",
    choice_best==1 & h1>w1 ~ "a",
    choice_best==1 & w1>h1 ~ "b",
    choice_best==2 & h2>w2 ~ "a",
    choice_best==2 & w2>h2 ~ "b",
    choice_best==3 & h3>w3 ~ "a",
    choice_best==3 & w3>h3 ~ "b",
  ),
  worst=case_when(
    choice_worst==min~"d",
    choice_worst==1 & h1>w1 ~ "a",
    choice_worst==1 & w1>h1 ~ "b",
    choice_worst==2 & h2>w2 ~ "a",
    choice_worst==2 & w2>h2 ~ "b",
    choice_worst==3 & h3>w3 ~ "a",
    choice_worst==3 & w3>h3 ~ "b",
  ),
  best_att=case_when(
    best=="a" & set=="a-b-da"~"t",
    best=="a" & set=="a-b-db"~"c",
  ...
  worst_att=case_when(
    worst=="a" & set=="a-b-da"~"t",
    worst=="a" & set=="a-b-db"~"c",
    worst=="b" & set=="a-b-da"~"c",
    worst=="b" & set=="a-b-db"~"t",
    worst=="d"~"d"
  ))
